...
// copy from spring-jdbc-5.3.18:\org\springframework\jdbc\datasource\init\ScriptUtils.java
...
/**
 * Copy from {@link ScriptUtils} in spring-jdbc-5.3.18.
 ...
 */
public abstract class ScriptUtilsEnhanced {
	...
	private static final Log logger = LogFactory.getLog(ScriptUtilsEnhanced.class);
