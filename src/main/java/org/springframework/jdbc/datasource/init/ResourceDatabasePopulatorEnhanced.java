...
// copy from spring-jdbc-5.3.18:\org\springframework\jdbc\datasource\init\ResourceDatabasePopulator.java
...
/**
 * Copy from {@link ResourceDatabasePopulator} in spring-jdbc-5.3.18.
...
public class ResourceDatabasePopulatorEnhanced implements DatabasePopulator {
	...
	private String separator = ScriptUtilsEnhanced.DEFAULT_STATEMENT_SEPARATOR;

	private String[] commentPrefixes = ScriptUtilsEnhanced.DEFAULT_COMMENT_PREFIXES;

	private String blockCommentStartDelimiter = ScriptUtilsEnhanced.DEFAULT_BLOCK_COMMENT_START_DELIMITER;

	private String blockCommentEndDelimiter = ScriptUtilsEnhanced.DEFAULT_BLOCK_COMMENT_END_DELIMITER;
	 ...
	 * @since 4.0.3
	 */
	public ResourceDatabasePopulatorEnhanced() {
	}
	 ...
	 * @since 4.0.3
	 */
	public ResourceDatabasePopulatorEnhanced(Resource... scripts) {
		setScripts(scripts);
	}
	 ...
	 * @since 4.0.3
	 */
	public ResourceDatabasePopulatorEnhanced(boolean continueOnError, boolean ignoreFailedDrops,
	 ...
	 * as a last resort; may be set to {@link ScriptUtilsEnhanced#EOF_STATEMENT_SEPARATOR}
	...
	public void populate(Connection connection) throws ScriptException {
		...
		for (Resource script : this.scripts) {
			...
			ScriptUtilsEnhanced.executeSqlScript(connection, encodedScript, this.continueOnError, this.ignoreFailedDrops,
