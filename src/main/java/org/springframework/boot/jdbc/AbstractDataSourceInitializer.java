...
public abstract class AbstractDataSourceInitializer implements InitializingBean {
    ...
    protected String getDatabaseName() {
        try {
            String metaDataProductName = JdbcUtils.extractDatabaseMetaData(this.dataSource, DatabaseMetaData::getDatabaseProductName).toString();
            String productName = JdbcUtils.commonDatabaseName(metaDataProductName);
